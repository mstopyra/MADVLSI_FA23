...
C {madvlsi/vsource.sym} -380 -185 0 0 {name=V1
value=0.5}
C {madvlsi/vsource.sym} -380 -65 0 0 {name=V2
value= 0.86}
C {devices/lab_pin.sym} -380 -215 0 0 {name=p3 sig_type=std_logic lab=V1}
...
C {devices/lab_pin.sym} -380 -95 0 0 {name=p6 sig_type=std_logic lab=V2}
C {madvlsi/gnd.sym} -380 -155 0 0 {name=l2 lab=GND}
C {madvlsi/gnd.sym} -380 -35 0 0 {name=l3 lab=GND}
C {madvlsi/vsource.sym} -485 -115 0 0 {name=VDD

value=1.8}
C {madvlsi/gnd.sym} -485 -85 0 0 {name=l1 lab=GND}
C {madvlsi/vdd.sym} -485 -145 0 0 {name=l4 lab=VDD}
C {devices/gnd.sym} 0 240 0 0 {name=l6 lab=GND}
C {madvlsi/capacitor.sym} 0 210 0 0 {name=C1
value=2p
m=1}
C {madvlsi/vsource.sym} -265 -175 0 0 {name=VOUT
value=1.2}
C {madvlsi/gnd.sym} -265 -145 0 0 {name=l5 lab=GND}
C {devices/ammeter.sym} 0 110 0 0 {name=Vmeas}
C {devices/lab_pin.sym} 0 160 2 0 {name=p1 sig_type=std_logic lab=VOUT}
C {devices/lab_pin.sym} -265 -205 2 0 {name=p2 sig_type=std_logic lab=VOUT}
